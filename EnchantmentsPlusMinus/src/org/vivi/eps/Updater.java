...
public class Updater
{
	...
	public void makeCompatible()
	{
		...
		if (EPS.configFile.contains("open-enchant-gui-on-right-click"))
		{
			EPS.configFile.set("enchant-gui-shortcut.on-right-click", EPS.configFile.getBoolean("open-enchant-gui-on-right-click"));
